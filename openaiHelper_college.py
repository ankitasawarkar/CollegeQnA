    ...
    functions = [
        {
            ...
            "parameters": {
                ...
                "properties": {
                    "student_name": {
                        "type": "string",
                        "description": "First and last Name of the student. e.g Aanya Gupta",
                    },
                    "semester": {
                        "type": "integer",
                        "description": "A number between 1 to 5 indicating the semester of a student",
                    },
                    "operation": {
                        "type": "string",
...
if __name__ == '__main__':
    print("What was Aanya Gupta's GPA in semester 1?",get_answer("What was Aanya Gupta's GPA in semester 1?"))
    #print(get_answer("average gpa in third semester?"))
    #print(get_answer("how much is Ishaan Patel's pending fees in the first semester?"))
    #print(get_answer("how much was Riya Singh's due fees in the first semester?"))
